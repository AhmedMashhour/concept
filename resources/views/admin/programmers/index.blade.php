...
@section('content')
    ...
    <div class="box">
        ...
        <div class="box-body">
            <form method="post" action="{{aurl('programmers/destroy/all')}}" id="admins_form">
                <input type="hidden" name="_token" value="{{csrf_token()}}">
                <input type="hidden" name="_method" value="DELETE">

    {!! $dataTable->table([
        'class'=>'dataTable table table-striped table-hover table-responsive table-bordered'],true) !!}
        ...
        <div class="modal-dialog">
            <div class="modal-content" id="popupdelete">
                ...
                <div class="modal-body">
                   <h2> <strong class="msg" style="color:red;">You will Delete Selected Programmers !</strong></h2>
                </div>
